                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered zero-configuration display" id="example">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nik</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($Gaji as $pgw) : ?>
                                        <tr>
                                            ...
                                            <td><?= $pgw['bonus'] ?></td>
                                            <td><?= $pgw['potongan'] ?></td>
                                            <td><?= $pgw['gaji_pokok'] + $pgw['bonus'] - $pgw['potongan'] ?></td>
                                            <td>
                                                <a href="" class="badge badge-success">edit</a>
                                                <!-- <a href="<?= base_url() ?>/admin/hapus/<?= $pgw['id_pegawai']; ?>" class="badge badge-danger" onclick="return confirm('yakin?');">hapus</a> -->
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
                                    ...
                                    <div class="form-validation">
                                        <form class="form-valide" action="<?= base_url('admin/tambahdata') ?>" method="post">
                                            ...
                                            status">
                                                ...
                                                status" name="status" value=1 checked>
